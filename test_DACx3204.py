...
dac.write_func_config(channel=0, enc_slew_rate=dac.ENC_SLEW_RATE_4US, enc_code_step=dac.ENC_CODE_STEP_32LSB, enc_func_config=dac.ENC_FUNC_CONFIG_SAWTOOTH)
